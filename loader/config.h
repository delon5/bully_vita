...
// Create this file to cut the FIOS RAM caches to one block each, freeing the
// 32 MB they hold. See the comment in fios.c: it is a controlled test of
// whether they are in the path of the game's reads at all.
